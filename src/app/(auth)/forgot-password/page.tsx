...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-50 dark:bg-black">
      {/* Background blobs */}
      <div className="absolute top-0 -right-6 w-72 h-72 bg-blue-500 rounded-full mix-blend-multiply filter blur-[128px] opacity-20 dark:opacity-10 animate-pulse"></div>
      <div className="absolute bottom-0 -left-6 w-72 h-72 bg-purple-500 rounded-full mix-blend-multiply filter blur-[128px] opacity-20 dark:opacity-10 animate-pulse" style={{ animationDelay: '2s' }}></div>
        ...
        <div className="relative">
          ...
          <div className="relative flex flex-col gap-4 p-6 bg-white/80 dark:bg-black/70 backdrop-blur-xl border border-white/40 dark:border-white/10 rounded-2xl shadow-2xl">
            ...
            <div className="text-center">
              ...
              <h1 className="text-lg font-extrabold text-slate-900 dark:text-white tracking-tight">Recuperar</h1>
              <p className="text-slate-500 dark:text-slate-400 text-[10px] mt-1">Enviaremos un enlace a tu correo</p>
            </div>
            ...
            {state?.success ? (
              ...
              <form action={formAction} className="flex flex-col gap-4">
                <div className="flex flex-col gap-1 group">
                  <label htmlFor="email" className="text-[10px] font-semibold text-slate-700 dark:text-slate-300 ml-1">
                    Correo Electrónico
                  </label>
                  <div className="relative">
                    <input

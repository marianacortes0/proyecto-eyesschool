  ...
  return (
    <main className="relative min-h-screen flex flex-col">
      ...
      <section className="flex items-center justify-center text-center py-40 px-6">
        <div className="bg-[#d7e0e9] dark:bg-[#141414] backdrop-blur-xl p-16 rounded-3xl shadow-xl border border-white/20 dark:border-white/10 max-w-4xl">
      ...
      <section className="py-20 px-6 max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
        {[
          ...
          <div
            key={i}
            className="bg-[#d7e0e9] dark:bg-[#141414] backdrop-blur-xl p-8 rounded-2xl shadow border border-white/20 dark:border-white/10"
          >
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
        ...
        <div className="bg-[#d7e0e9] dark:bg-[#141414] backdrop-blur-xl p-10 rounded-3xl shadow border border-white/20 dark:border-white/10">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-lg">
            ...
            optimicen procesos administrativos y académicos.
          </p>
        </div>
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto grid md:grid-cols-3 gap-10">
        ...
        {[
          { icon: "⚡", title: "Rápido", text: "Todo funciona en segundos." },
          { icon: "🎯", title: "Intuitivo", text: "Diseñado para cualquiera." },
          { icon: "🔒", title: "Seguro", text: "Tus datos protegidos." },
        ].map((item, i) => (
          <div
            key={i}
      ...
      <section className="py-28 px-6 max-w-6xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-4 gap-10">
          {["Samuel Sierra","Mariana Cortez","Andres Acero","Sergio Gomes"].map((name, i) => (
            <div
              key={i}
              className="bg-[#d7e0e9] dark:bg-[#141414] backdrop-blur-xl p-10 rounded-3xl shadow border border-white/20 dark:border-white/10 hover:-translate-y-3 transition"
            >
